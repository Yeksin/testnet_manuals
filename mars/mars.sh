...
echo -e "Your chain name: \e[1m\e[32m$MARS_CHAIN_ID\e[0m"
echo -e "Your port: \e[1m\e[32m$MARS_PORT\e[0m"
echo '================================================='
sleep 2
...
echo -e "To check sync status: \e[1m\e[32mcurl -s localhost:${MARS_PORT}657/status | jq .result.sync_info\e[0m"
