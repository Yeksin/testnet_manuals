...
### Option 1 (manual)
You can follow [manual guide](https://github.com/yeksinNodes/testnet_manuals/blob/main/sge/manual_install.md) if you better prefer setting up node manually
...
```
wget -O sge.sh https://raw.githubusercontent.com/yeksinNodes/testnet_manuals/main/sge/sge.sh && chmod +x sge.sh && ./sge.sh
```
