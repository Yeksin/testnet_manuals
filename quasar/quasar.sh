...
echo -e "Your chain name: \e[1m\e[32m$QUASAR_CHAIN_ID\e[0m"
echo -e "Your port: \e[1m\e[32m$QUASAR_PORT\e[0m"
echo '================================================='
sleep 2
...
echo '=============== SETUP FINISHED ==================='
echo -e 'To check logs: \e[1m\e[32mjournalctl -u quasarnoded -f -o cat\e[0m'
echo -e "To check sync status: \e[1m\e[32mcurl -s localhost:${QUASAR_PORT}657/status | jq .result.sync_info\e[0m"
